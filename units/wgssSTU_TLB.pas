...
const
  ...
  IID_IHandwritingThicknessColor
    : TGUID = '{20004323-9CF7-4375-B7C3-DEFDF8588FAD}';
  ...
  IID_ITabletEncryptionHandler
    : TGUID = '{2000B2ED-AEDA-4E86-8A69-BB987FA3B238}';
...
type
  ...
  IProtocol = interface(IDispatch)
    ...
    procedure setHandwritingThicknessColor(const HandwritingThicknessColor
      : IHandwritingThicknessColor); safecall;
    ...
    procedure setHandwritingDisplayArea(const handwritingDisplayArea
      : IHandwritingDisplayArea); safecall;
  ...
  IProtocolDisp = dispinterface
    ...
    procedure setHostPublicKey(publicKey: { ??PSafeArray } OleVariant);
      dispid 2313;
  ...
  IInterfaceQueue = interface(IDispatch)
    ...
    function waitGetReportPredicate(const predicate: IPredicate)
      : PSafeArray; safecall;
  end;
  ...
  IInterfaceQueueDisp = dispinterface
    ...
    function tryGetReport(out report: { ??PSafeArray } OleVariant): WordBool;
      dispid 517;
    function waitGetReportPredicate(const predicate: IPredicate)
      : { ??PSafeArray } OleVariant; dispid 518;
  end;
  ...
  IInkThreshold = interface(IDispatch)
    ...
    property onPressureMark: Word read Get_onPressureMark
      write Set_onPressureMark;
    property offPressureMark: Word read Get_offPressureMark
      write Set_offPressureMark;
  end;
  ...
  IHandwritingDisplayArea = interface(IDispatch)
    ...
    property upperLeftXPixel: Word read Get_upperLeftXPixel
      write Set_upperLeftXPixel;
    property upperLeftYPixel: Word read Get_upperLeftYPixel
      write Set_upperLeftYPixel;
    property lowerRightXPixel: Word read Get_lowerRightXPixel
      write Set_lowerRightXPixel;
    property lowerRightYPixel: Word read Get_lowerRightYPixel
      write Set_lowerRightYPixel;
  end;
  ...
  IUsbInterface = interface(IInterface)
    ...
    function connect(const usbDevice: IUsbDevice; exclusiveLock: WordBool)
      : IErrorCode; safecall;
    function connect2(const fileName: WideString;
      const bulkFileName: WideString; exclusiveLock: WordBool)
      : IErrorCode; safecall;
  end;
  ...
  IUsbInterfaceDisp = dispinterface
    ['{2000C1D7-8270-490B-A8F3-766258E6BAB9}']
    function connect(const usbDevice: IUsbDevice; exclusiveLock: WordBool)
      : IErrorCode; dispid 1025;
    function connect2(const fileName: WideString;
      const bulkFileName: WideString; exclusiveLock: WordBool): IErrorCode;
      dispid 1026;
    procedure disconnect; dispid 769;
    function isConnected: WordBool; dispid 770;
    procedure get(data: { ??PSafeArray } OleVariant); dispid 771;
  ...
  ISerialInterface = interface(IInterface)
    ...
    function connect(const fileName: WideString; useCrc: WordBool)
      : IErrorCode; safecall;
  end;
  ...
  ISerialInterfaceDisp = dispinterface
    ['{20003D0C-A047-4487-8FE0-0CF9AB05E48C}']
    function connect(const fileName: WideString; useCrc: WordBool): IErrorCode;
      dispid 5889;
    procedure disconnect; dispid 769;
    function isConnected: WordBool; dispid 770;
    procedure get(data: { ??PSafeArray } OleVariant); dispid 771;
  ...
  IProtocolHelper = interface(IDispatch)
    ...
    function statusCanSend(statusCode: Byte; ReportId: Byte;
      OpDirection: OpDirection): WordBool; safecall;
    ...
    procedure waitForStatus(const Protocol: IProtocol; statusCode: Byte;
    ...
    function supportsEncryption_DHprime(dhPrime: PSafeArray): WordBool;
      safecall;
    function setHostPublicKeyAndPollForDevicePublicKey(const Protocol
      : IProtocol; hostPublicKey: PSafeArray; retries: SYSUINT;
    ...
    procedure writeImage(const Protocol: IProtocol; encodingMode: Byte;
      ...
      sleepBetweenRetries: SYSUINT); safecall;
    function flattenMonochrome(image: OleVariant; screenWidth: Word;
      screenHeight: Word): PSafeArray; safecall;
    function flattenColor16_565(image: OleVariant; screenWidth: Word;
      screenHeight: Word): PSafeArray; safecall;
    function flatten(image: OleVariant; screenWidth: Word; screenHeight: Word;
      isColor: WordBool): PSafeArray; safecall;
    function resizeAndFlatten(image: OleVariant; offsetX: SYSUINT;
      offsetY: SYSUINT; bitmapWidth: SYSUINT; bitmapHeight: SYSUINT;
      screenWidth: Word; screenHeight: Word; isColor: WordBool; Scale: Scale;
  ...
  IProtocolHelperDisp = dispinterface
    ['{2000550B-EFC5-4D5F-8969-45C9A67CC93C}']
    function statusCanSend(statusCode: Byte; ReportId: Byte;
      OpDirection: OpDirection): WordBool; dispid 6145;
    procedure waitForStatusToSend(const Protocol: IProtocol; ReportId: Byte;
      OpDirection: OpDirection; retries: SYSUINT; sleepBetweenRetries: SYSUINT);
      dispid 6146;
    procedure waitForStatus(const Protocol: IProtocol; statusCode: Byte;
      retries: SYSUINT; sleepBetweenRetries: SYSUINT); dispid 6147;
    function supportsEncryption(const Protocol: IProtocol): WordBool;
      dispid 6148;
    function supportsEncryption_DHprime(dhPrime: { ??PSafeArray } OleVariant)
      : WordBool; dispid 6149;
    function setHostPublicKeyAndPollForDevicePublicKey(const Protocol
      : IProtocol; hostPublicKey: { ??PSafeArray } OleVariant; retries: SYSUINT;
    ...
    function flattenMonochrome(image: OleVariant;
      screenWidth: { ??Word } OleVariant; screenHeight: { ??Word } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 6153;
    function flattenColor16_565(image: OleVariant;
      screenWidth: { ??Word } OleVariant; screenHeight: { ??Word } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 6154;
    function flatten(image: OleVariant; screenWidth: { ??Word } OleVariant;
      screenHeight: { ??Word } OleVariant; isColor: WordBool)
      : { ??PSafeArray } OleVariant; dispid 6155;
    function resizeAndFlatten(image: OleVariant; offsetX: SYSUINT;
      offsetY: SYSUINT; bitmapWidth: SYSUINT; bitmapHeight: SYSUINT;
      screenWidth: { ??Word } OleVariant; screenHeight: { ??Word } OleVariant;
      isColor: WordBool; Scale: Scale; backgroundColor: OleVariant; Clip: Byte)
      : { ??PSafeArray } OleVariant; dispid 6156;
  end;
  ...
  IReportHandlerDisp = dispinterface
    ['{2000446E-736E-4513-9751-A9B69648863E}']
    function handleReport(data: { ??PSafeArray } OleVariant): WordBool;
      dispid 5121;
  end;
  ...
  ITabletEncryptionHandlerDisp = dispinterface
    ...
    procedure setDH(dhPrime: { ??PSafeArray } OleVariant;
      dhBase: { ??PSafeArray } OleVariant); dispid 7172;
    function generateHostPublicKey: { ??PSafeArray } OleVariant; dispid 7173;
    procedure computeSharedKey(devicePublicKey: { ??PSafeArray } OleVariant);
      dispid 7174;
    function decrypt(data: { ??PSafeArray } OleVariant)
      : { ??PSafeArray } OleVariant; dispid 7175;
  end;
  ...
  ITablet = interface(IDispatch)
    ...
    procedure Set_encryptionHandler(const pRetVal
      : ITabletEncryptionHandler); safecall;
    function usbConnect(const usbDevice: IUsbDevice; exclusiveLock: WordBool)
      : IErrorCode; safecall;
    function usbConnect2(const fileName: WideString;
      const bulkFileName: WideString; exclusiveLock: WordBool)
      : IErrorCode; safecall;
    function serialConnect(const fileName: WideString; useCrc: WordBool)
      : IErrorCode; safecall;
    function Get_Protocol: IProtocol; safecall;
    ...
    function getPenDataOptionMode: Byte; safecall;
    procedure setPenDataOptionMode(penDataOptionMode: Byte); safecall;
    property encryptionHandler: ITabletEncryptionHandler
      read Get_encryptionHandler write Set_encryptionHandler;
    property Protocol: IProtocol read Get_Protocol;
  end;
  ...
  ITabletDisp = dispinterface
    ...
    function usbConnect(const usbDevice: IUsbDevice; exclusiveLock: WordBool)
      : IErrorCode; dispid 6658;
    function usbConnect2(const fileName: WideString;
      const bulkFileName: WideString; exclusiveLock: WordBool): IErrorCode;
      dispid 6659;
    function serialConnect(const fileName: WideString; useCrc: WordBool)
      : IErrorCode; dispid 6660;
    ...
    procedure getReportCountLengths(var pRetVal: { ??PSafeArray } OleVariant);
      dispid 6668;
    ...
    procedure writeImage(encodingMode: Byte;
      imageData: { ??PSafeArray } OleVariant); dispid 6689;
    procedure endImageData; dispid 6690;
    function getHandwritingThicknessColor: IHandwritingThicknessColor;
      dispid 6691;
    procedure setHandwritingThicknessColor(const HandwritingThicknessColor
      : IHandwritingThicknessColor); dispid 6692;
    ...
    procedure setHandwritingDisplayArea(const handwritingDisplayArea
      : IHandwritingDisplayArea); dispid 6696;
    function getBacklightBrightness: { ??Word } OleVariant; dispid 6697;
    procedure setBacklightBrightness(backlightBrightness
      : { ??Word } OleVariant); dispid 6698;
  ...
  IJScript = interface(IDispatch)
    ...
    function toTabletEncryptionHandler(const value: IDispatch)
      : ITabletEncryptionHandler; safecall;
  end;
  ...
  IJScriptDisp = dispinterface
    ['{200072FE-6F48-44D0-8C0A-4ABAE07EDFF6}']
    function toArray(value: { ??PSafeArray } OleVariant): IDispatch;
      dispid 6401;
    function toVBArray(const value: IDispatch): { ??PSafeArray } OleVariant;
      dispid 6402;
    function toTabletEncryptionHandler(const value: IDispatch)
      : ITabletEncryptionHandler; dispid 6403;
  end;
  ...
  IReportHandlerEvents = dispinterface
    ...
    procedure onPenDataOption(const pPenDataOption: IPenDataOption);
      dispid 5378;
    procedure onPenDataEncrypted(const pPenDataEncrypted: IPenDataEncrypted);
      dispid 5379;
    procedure onPenDataEncryptedOption(const pPenDataEncryptedOption
      : IPenDataEncryptedOption); dispid 5380;
    procedure onDevicePublicKey(pDevicePublicKey: { ??PSafeArray } OleVariant);
      dispid 5381;
  ...
  ITabletEvents = dispinterface
    ...
    procedure onGetReportException(const pException: ITabletEventsException);
      dispid 6913;
    procedure onUnhandledReportData(pData: { ??PSafeArray } OleVariant);
      dispid 6914;
    ...
    procedure onPenDataEncrypted(const pPenDataEncrypted: IPenDataEncrypted);
      dispid 6917;
    procedure onPenDataEncryptedOption(const pPenDataEncryptedOption
      : IPenDataEncryptedOption); dispid 6918;
    procedure onDevicePublicKey(pDevicePublicKey: { ??PSafeArray } OleVariant);
      dispid 6919;
  end;
  ...
  TUsbInterfaceonReport = procedure(ASender: TObject; const pData: IReport)
    of object;
...
{$ENDIF}
  ...
  public
    ...
    function connect1(const usbDevice: IUsbDevice; exclusiveLock: WordBool)
      : IErrorCode;
    function connect2(const fileName: WideString;
      const bulkFileName: WideString; exclusiveLock: WordBool): IErrorCode;
...
{$ENDIF}
    property OnonReport: TUsbInterfaceonReport read FOnonReport
      write FOnonReport;
  end;
...
{$ENDIF}
  ...
  TSerialInterfaceonReport = procedure(ASender: TObject; const pData: IReport)
    of object;
...
{$ENDIF}
    property OnonReport: TSerialInterfaceonReport read FOnonReport
      write FOnonReport;
  end;
...
{$ENDIF}
  ...
  public
    ...
    procedure disconnect; override;
    function statusCanSend(statusCode: Byte; ReportId: Byte;
      OpDirection: OpDirection): WordBool;
    procedure waitForStatusToSend(const Protocol: IProtocol; ReportId: Byte;
      OpDirection: OpDirection; retries: SYSUINT; sleepBetweenRetries: SYSUINT);
    procedure waitForStatus(const Protocol: IProtocol; statusCode: Byte;
...
{$ENDIF}
  ...
  TReportHandleronPenData = procedure(ASender: TObject;
    const pPenData: IPenData) of object;
  TReportHandleronPenDataOption = procedure(ASender: TObject;
    const pPenDataOption: IPenDataOption) of object;
  TReportHandleronPenDataEncrypted = procedure(ASender: TObject;
    const pPenDataEncrypted: IPenDataEncrypted) of object;
  TReportHandleronPenDataEncryptedOption = procedure(ASender: TObject;
    const pPenDataEncryptedOption: IPenDataEncryptedOption) of object;
  TReportHandleronDevicePublicKey = procedure(ASender: TObject;
    pDevicePublicKey: { ??PSafeArray } OleVariant) of object;
  TReportHandleronDecrypt = procedure(ASender: TObject; const pData: IDecrypt)
    of object;
...
{$ENDIF}
    property OnonPenData: TReportHandleronPenData read FOnonPenData
      write FOnonPenData;
    property OnonPenDataOption: TReportHandleronPenDataOption
      read FOnonPenDataOption write FOnonPenDataOption;
    property OnonPenDataEncrypted: TReportHandleronPenDataEncrypted
      read FOnonPenDataEncrypted write FOnonPenDataEncrypted;
    property OnonPenDataEncryptedOption: TReportHandleronPenDataEncryptedOption
      read FOnonPenDataEncryptedOption write FOnonPenDataEncryptedOption;
    property OnonDevicePublicKey: TReportHandleronDevicePublicKey
      read FOnonDevicePublicKey write FOnonDevicePublicKey;
    property OnonDecrypt: TReportHandleronDecrypt read FOnonDecrypt
      write FOnonDecrypt;
  end;
...
{$ENDIF}
  ...
  TTabletonGetReportException = procedure(ASender: TObject;
    const pException: ITabletEventsException) of object;
  TTabletonUnhandledReportData = procedure(ASender: TObject;
    pData: { ??PSafeArray } OleVariant) of object;
  TTabletonPenData = procedure(ASender: TObject; const pPenData: IPenData)
    of object;
  TTabletonPenDataOption = procedure(ASender: TObject;
    const pPenDataOption: IPenDataOption) of object;
  TTabletonPenDataEncrypted = procedure(ASender: TObject;
    const pPenDataEncrypted: IPenDataEncrypted) of object;
  TTabletonPenDataEncryptedOption = procedure(ASender: TObject;
    const pPenDataEncryptedOption: IPenDataEncryptedOption) of object;
  TTabletonDevicePublicKey = procedure(ASender: TObject;
    pDevicePublicKey: { ??PSafeArray } OleVariant) of object;
...
{$ENDIF}
    property OnonGetReportException: TTabletonGetReportException
      read FOnonGetReportException write FOnonGetReportException;
    property OnonUnhandledReportData: TTabletonUnhandledReportData
      read FOnonUnhandledReportData write FOnonUnhandledReportData;
    property OnonPenData: TTabletonPenData read FOnonPenData write FOnonPenData;
    property OnonPenDataOption: TTabletonPenDataOption read FOnonPenDataOption
      write FOnonPenDataOption;
    property OnonPenDataEncrypted: TTabletonPenDataEncrypted
      read FOnonPenDataEncrypted write FOnonPenDataEncrypted;
    property OnonPenDataEncryptedOption: TTabletonPenDataEncryptedOption
      read FOnonPenDataEncryptedOption write FOnonPenDataEncryptedOption;
    property OnonDevicePublicKey: TTabletonDevicePublicKey
      read FOnonDevicePublicKey write FOnonDevicePublicKey;
  end;
...
class function CoUsbInterface.CreateRemote(const MachineName: string)
  : IUsbInterface;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_UsbInterface)
    as IUsbInterface;
end;

procedure TUsbInterface.InitServerData;
const
  CServerData: TServerData = (ClassID: '{2000BC66-5735-45C7-9521-93FAAFE8C3BB}';
    IntfIID: '{2000C1D7-8270-490B-A8F3-766258E6BAB9}';
    EventIID: '{2000A1EE-8F0B-4027-B84E-A8172950CF0C}'; LicenseKey: nil;
    version: 500);
begin
...
begin
  case DispID of
    - 1:
      Exit; // DISPID_UNKNOWN
    1537:
      if Assigned(FOnonReport) then
        FOnonReport(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IReport { const IReport } );
  end; { case DispID }
end;

function TUsbInterface.connect1(const usbDevice: IUsbDevice;
  exclusiveLock: WordBool): IErrorCode;
begin
  Result := DefaultInterface.connect(usbDevice, exclusiveLock);
end;

function TUsbInterface.connect2(const fileName: WideString;
  const bulkFileName: WideString; exclusiveLock: WordBool): IErrorCode;
begin
...
class function CoSerialInterface.CreateRemote(const MachineName: string)
  : ISerialInterface;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_SerialInterface)
    as ISerialInterface;
end;

procedure TSerialInterface.InitServerData;
const
  CServerData: TServerData = (ClassID: '{20001CFF-184E-4E32-9FC4-A617533D342E}';
...
procedure TSerialInterface.InvokeEvent(dispid: TDispID;
...
function TSerialInterface.connect1(const fileName: WideString; useCrc: WordBool)
  : IErrorCode;
begin
...
class function CoUsbDevices.CreateRemote(const MachineName: string)
  : IUsbDevices;
begin
...
const
  CServerData: TServerData = (ClassID: '{2000D7A5-64F7-4826-B56E-85ACC618E4D6}';
    IntfIID: '{20008CC2-6576-4665-8411-99291CF18387}'; EventIID: '';
...
const
  CServerData: TServerData = (ClassID: '{2000D408-6AFE-4CBA-BDB1-DA087DA66B05}';
    IntfIID: '{200072FE-6F48-44D0-8C0A-4ABAE07EDFF6}'; EventIID: '';
    LicenseKey: nil; version: 500);
begin
  ServerData := @CServerData;
end;
...
function TJScript.toTabletEncryptionHandler(const value: IDispatch)
  : ITabletEncryptionHandler;
begin
...
class function CoProtocolHelper.CreateRemote(const MachineName: string)
  : IProtocolHelper;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ProtocolHelper)
    as IProtocolHelper;
end;

procedure TProtocolHelper.InitServerData;
const
  CServerData: TServerData = (ClassID: '{2000CF89-E182-40AD-A8C2-5694987EA5DF}';
    IntfIID: '{2000550B-EFC5-4D5F-8969-45C9A67CC93C}'; EventIID: '';
    LicenseKey: nil; version: 500);
begin
  ServerData := @CServerData;
end;
...
function TProtocolHelper.statusCanSend(statusCode: Byte; ReportId: Byte;
  OpDirection: OpDirection): WordBool;
begin
  Result := DefaultInterface.statusCanSend(statusCode, ReportId, OpDirection);
end;

procedure TProtocolHelper.waitForStatusToSend(const Protocol: IProtocol;
  ReportId: Byte; OpDirection: OpDirection; retries: SYSUINT;
  sleepBetweenRetries: SYSUINT);
begin
  DefaultInterface.waitForStatusToSend(Protocol, ReportId, OpDirection, retries,
    sleepBetweenRetries);
end;

procedure TProtocolHelper.waitForStatus(const Protocol: IProtocol;
  statusCode: Byte; retries: SYSUINT; sleepBetweenRetries: SYSUINT);
begin
  DefaultInterface.waitForStatus(Protocol, statusCode, retries,
    sleepBetweenRetries);
end;

function TProtocolHelper.supportsEncryption(const Protocol: IProtocol)
  : WordBool;
begin
  Result := DefaultInterface.supportsEncryption(Protocol);
end;

function TProtocolHelper.supportsEncryption_DHprime(dhPrime: PSafeArray)
  : WordBool;
begin
  Result := DefaultInterface.supportsEncryption_DHprime(dhPrime);
end;

function TProtocolHelper.setHostPublicKeyAndPollForDevicePublicKey
  (const Protocol: IProtocol; hostPublicKey: PSafeArray; retries: SYSUINT;
  sleepBetweenRetries: SYSUINT): PSafeArray;
begin
  Result := DefaultInterface.setHostPublicKeyAndPollForDevicePublicKey(Protocol,
    hostPublicKey, retries, sleepBetweenRetries);
end;

procedure TProtocolHelper.writeImage(const Protocol: IProtocol;
  encodingMode: Byte; imageData: PSafeArray; retries: SYSUINT;
  sleepBetweenRetries: SYSUINT);
begin
  DefaultInterface.writeImage(Protocol, encodingMode, imageData, retries,
    sleepBetweenRetries);
end;

function TProtocolHelper.flattenMonochrome(image: OleVariant; screenWidth: Word;
  screenHeight: Word): PSafeArray;
begin
  Result := DefaultInterface.flattenMonochrome(image, screenWidth,
    screenHeight);
end;

function TProtocolHelper.flattenColor16_565(image: OleVariant;
  screenWidth: Word; screenHeight: Word): PSafeArray;
begin
  Result := DefaultInterface.flattenColor16_565(image, screenWidth,
    screenHeight);
end;

function TProtocolHelper.flatten(image: OleVariant; screenWidth: Word;
  screenHeight: Word; isColor: WordBool): PSafeArray;
begin
  Result := DefaultInterface.flatten(image, screenWidth, screenHeight, isColor);
end;

function TProtocolHelper.resizeAndFlatten(image: OleVariant; offsetX: SYSUINT;
  offsetY: SYSUINT; bitmapWidth: SYSUINT; bitmapHeight: SYSUINT;
  screenWidth: Word; screenHeight: Word; isColor: WordBool; Scale: Scale;
  backgroundColor: OleVariant; Clip: Byte): PSafeArray;
begin
  Result := DefaultInterface.resizeAndFlatten(image, offsetX, offsetY,
    bitmapWidth, bitmapHeight, screenWidth, screenHeight, isColor, Scale,
...
class function CoReportHandler.CreateRemote(const MachineName: string)
  : IReportHandler;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ReportHandler)
    as IReportHandler;
end;

procedure TReportHandler.InitServerData;
const
  CServerData: TServerData = (ClassID: '{20008BA5-8133-45BA-91A5-AB54A1F70E13}';
    IntfIID: '{2000446E-736E-4513-9751-A9B69648863E}';
    EventIID: '{20004D65-E291-4B63-8062-7E99EBD21BDF}'; LicenseKey: nil;
    version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure TReportHandler.InvokeEvent(dispid: TDispID;
  var Params: TVariantArray);
begin
  case DispID of
    - 1:
      Exit; // DISPID_UNKNOWN
    5377:
      if Assigned(FOnonPenData) then
        FOnonPenData(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IPenData { const IPenData } );
    5378:
      if Assigned(FOnonPenDataOption) then
        FOnonPenDataOption(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IPenDataOption { const IPenDataOption } );
    5379:
      if Assigned(FOnonPenDataEncrypted) then
        FOnonPenDataEncrypted(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IPenDataEncrypted { const IPenDataEncrypted } );
    5380:
      if Assigned(FOnonPenDataEncryptedOption) then
        FOnonPenDataEncryptedOption(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IPenDataEncryptedOption { const IPenDataEncryptedOption } );
    5381:
      if Assigned(FOnonDevicePublicKey) then
        FOnonDevicePublicKey(Self, Params[0] { ??PSafeArray OleVariant } );
    5382:
      if Assigned(FOnonDecrypt) then
        FOnonDecrypt(Self, IUnknown(TVarData(Params[0]).VPointer)
          as IDecrypt { const IDecrypt } );
  end; { case DispID }
end;
...
const
  CServerData: TServerData = (ClassID: '{20002178-1165-4D38-A7F5-B169DE2045C1}';
    IntfIID: '{20005C27-7729-492F-8106-540F2E04DC66}';
    EventIID: '{2000C72A-E338-477E-B359-D6D00006D29E}'; LicenseKey: nil;
    version: 500);
begin
  ServerData := @CServerData;
end;
...
begin
  case DispID of
    - 1:
      Exit; // DISPID_UNKNOWN
    6913:
      if Assigned(FOnonGetReportException) then
        FOnonGetReportException(Self, IUnknown(TVarData(Params[0]).VPointer)
          as ITabletEventsException { const ITabletEventsException } );
    6914:
      if Assigned(FOnonUnhandledReportData) then
...
procedure TTablet.Set_encryptionHandler(const pRetVal
  : ITabletEncryptionHandler);
begin
...
function TTablet.usbConnect(const usbDevice: IUsbDevice;
  exclusiveLock: WordBool): IErrorCode;
begin
  Result := DefaultInterface.usbConnect(usbDevice, exclusiveLock);
end;

function TTablet.usbConnect2(const fileName: WideString;
  const bulkFileName: WideString; exclusiveLock: WordBool): IErrorCode;
begin
  Result := DefaultInterface.usbConnect2(fileName, bulkFileName, exclusiveLock);
end;

function TTablet.serialConnect(const fileName: WideString; useCrc: WordBool)
  : IErrorCode;
begin
...
procedure TTablet.setHandwritingThicknessColor(const HandwritingThicknessColor
  : IHandwritingThicknessColor);
begin
...
procedure TTablet.setHandwritingDisplayArea(const handwritingDisplayArea
  : IHandwritingDisplayArea);
begin
...
procedure TTabletProperties.Set_encryptionHandler(const pRetVal
  : ITabletEncryptionHandler);
begin
  DefaultInterface.Set_encryptionHandler(pRetVal);
end;
...
const
  CServerData: TServerData = (ClassID: '{20000000-5D96-46B0-895F-B0CC7295E44D}';
    IntfIID: '{20001D33-3D2C-4E4D-AFE8-5E5D446637FD}'; EventIID: '';
    LicenseKey: nil; version: 500);
begin
  ServerData := @CServerData;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TUsbInterface, TSerialInterface,
    TUsbDevices, TJScript, TProtocolHelper, TReportHandler, TTablet,
    TComponent]);
end;
