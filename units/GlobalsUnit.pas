...
const
  ...
  ProductByEanURL =  'http://www.smartoys.be/catalog/product_info.php?products_id=';
  ProductImageURL = 'http://www.smartoys.be/catalog/images/';
  ParamRegPath = 'software\gopos\gomedia\params';
  CompanyName = 'SMARTOYS';
  DepositWarning = ' Smartoys se réserve le droit de se débarasser sans dédomagement des articles déposés en réparation depuis plus de 6 mois, le client est responsable de la récupération de ses produits avant cette échéance.';
  DepositComment = 'Attention !' + chr(10) + chr(13) +
            ...
            + chr(10) + chr(13) +
            ' Smartoys se réserve le droit de prélever 5€ sur le produit de la vente pour remettre en état les disques rayés.' + chr(10) + chr(13) +
