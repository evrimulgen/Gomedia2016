...
type
  ...
  CatalogSoap = interface(IInvokable)
    ...
    function ShowProductByCLDID(const CLDID: string): ShowProductByCLDIDResult; stdcall;
    function ShowProductByEAN(const EAN: string): ShowProductByEANResult; stdcall;
    function ShowBackOrders: ShowBackOrdersResult; stdcall;
    function OrderItem(const CLD_ID: string; const Q: Integer; const REF: string): Boolean; stdcall;
    function CliCheck(const SKU: string): Integer; stdcall;
    function RequestCode(const SKU: string; const sales_id: string): string; stdcall;
    function RequestPastCode(const SKU: string; const sales_id: string): string; stdcall;
  end;

function GetCatalogSoap(UseWSDL: Boolean = System.False; Addr: string = ''; HTTPRIO: THTTPRIO = nil): CatalogSoap;

implementation

uses SysUtils, WinInet;

class procedure TWebNodeAction.HTTPRIOHTTPWebNodeBeforePost(const HTTPReqResp: THTTPReqResp; Data: Pointer);
var
...
function GetCatalogSoap(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): CatalogSoap;
const
...
{ CatalogSoap }
InvRegistry.RegisterInterface(TypeInfo(CatalogSoap), 'http://service.cld.be/', 'utf-8');
InvRegistry.RegisterDefaultSOAPAction(TypeInfo(CatalogSoap), 'http://service.cld.be/%operationName%');
...
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'Identify', '', '[ReturnName="IdentifyResult"]');
{ CatalogSoap.HelloWorld }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'HelloWorld', '', '[ReturnName="HelloWorldResult"]', IS_OPTN);
{ CatalogSoap.ShowPricelist }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'ShowPricelist', '', '[ReturnName="ShowPricelistResult"]', IS_OPTN);
{ CatalogSoap.ShowProductByCLDID }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'ShowProductByCLDID', '', '[ReturnName="ShowProductByCLDIDResult"]', IS_OPTN);
{ CatalogSoap.ShowProductByEAN }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'ShowProductByEAN', '', '[ReturnName="ShowProductByEANResult"]', IS_OPTN);
{ CatalogSoap.ShowBackOrders }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'ShowBackOrders', '', '[ReturnName="ShowBackOrdersResult"]', IS_OPTN);
{ CatalogSoap.OrderItem }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'OrderItem', '', '[ReturnName="OrderItemResult"]');
{ CatalogSoap.CliCheck }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'CliCheck', '', '[ReturnName="CliCheckResult"]');
{ CatalogSoap.RequestCode }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'RequestCode', '', '[ReturnName="RequestCodeResult"]', IS_OPTN);
{ CatalogSoap.RequestPastCode }
InvRegistry.RegisterMethodInfo(TypeInfo(CatalogSoap), 'RequestPastCode', '', '[ReturnName="RequestPastCodeResult"]', IS_OPTN);
RemClassRegistry.RegisterXSClass(ShowPricelistResult, 'http://service.cld.be/', 'ShowPricelistResult');
RemClassRegistry.RegisterXSClass(ShowBackOrdersResult, 'http://service.cld.be/', 'ShowBackOrdersResult');
RemClassRegistry.RegisterXSClass(ShowProductByEANResult, 'http://service.cld.be/', 'ShowProductByEANResult');
RemClassRegistry.RegisterXSClass(ShowProductByCLDIDResult, 'http://service.cld.be/', 'ShowProductByCLDIDResult');
