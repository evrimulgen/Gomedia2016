...
{$R 'GoMedia2015Resource.res' 'GoMedia2015Resource.rc'}
{$R *.dres}
...
uses
  ...
  ReportModuleUnit
    in 'formsunits\ReportModuleUnit.pas' {ReportModule: TDataModule} ,
  ...
  RepairReturnFRMUnit
    in 'formsunits\RepairReturnFRMUnit.pas' {RepairReturnForm} ,
  DialogChangeEANFRMUnit
    in 'formsunits\DialogChangeEANFRMUnit.pas' {ChangeEANForm} ,
  DialogRefundFRMUnit in 'formsunits\DialogRefundFRMUnit.pas' {RefundForm} ,
  DialogCancelSalesFRMUnit
    in 'formsunits\DialogCancelSalesFRMUnit.pas' {CancelSalesForm} ,
  ...
  SalesCorrectFRMUnit
    in 'formsunits\SalesCorrectFRMUnit.pas' {SalesCorrectForm} ,
  InvoiceBatchPrintFRMUnit
    in 'formsunits\InvoiceBatchPrintFRMUnit.pas' {InvoiceBatchPrintForm} ,
  dtFormSetup in 'formsunits\dtFormSetup.pas' {dtSetupForm} ,
  CancelInvoiceItemFRMUnit
    in 'formsunits\CancelInvoiceItemFRMUnit.pas' {InvoicesCancelItemForm} ,
  CashRegistryFRMUnit
    in 'formsunits\CashRegistryFRMUnit.pas' {FormCashRegister} ,
  ...
  ExportWinbooksFRMUnit
    in 'formsunits\ExportWinbooksFRMUnit.pas' {FormExportWinbooks} ,
  CheckPrevious in 'units\CheckPrevious.pas',
  ProductSalesHistoryUnit
    in 'formsunits\ProductSalesHistoryUnit.pas' {FormProductSaleHistory} ,
  ChangeInvoiceFRMUnit
    in 'formsunits\ChangeInvoiceFRMUnit.pas' {FormChangeInvoice} ,
  DialogSearchCustFRMUnit
    in 'formsunits\DialogSearchCustFRMUnit.Pas' {FormSelectCust} ,
  DacalEmptyUnsoldFRMUnit
    in 'formsunits\DacalEmptyUnsoldFRMUnit.pas' {FormDacalEmptyUnsold} ,
  OrderCheckFRMUnit in 'formsunits\OrderCheckFRMUnit.pas' {OrderCheckForm} ,
  TransferRequestFRMUnit
    in 'formsunits\TransferRequestFRMUnit.pas' {TransferRequestFrom} ,
  ...
  CustomerDisplayFRMUnit
    in 'formsunits\CustomerDisplayFRMUnit.pas' {FormCustomerDisplay} ,
  ...
  ServerModuleGLight
    in 'formsunits\ServerModuleGLight.pas' {DSServerModuleRFIDPanel: TDSServerModule} ,
  FTPConn in 'units\FTPConn.pas',
  TransferSuggestFRMUnit
    in 'formsunits\TransferSuggestFRMUnit.pas' {TransferSuggest} ,
  ...
  wgssSTU_TLB in 'units\wgssSTU_TLB.pas',
  SignatureForm in 'formsunits\SignatureForm.pas' {FormSign} ,
  esd in 'units\esd.pas',
