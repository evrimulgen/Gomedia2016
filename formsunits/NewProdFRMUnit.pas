...
uses
  ...
  variants,
  Threadsunit, cxControls, cxContainer, cxEdit, cxTextEdit,
  cxMaskEdit,
  cxDropDownEdit, cxCalendar, cxDBEdit, pngimage, dxStatusBar,
  JvExControls,
  JvDBLookupTreeView, AdvMemo,
  DBAdvMemo, cxCurrencyEdit, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters;
...
begin
  RemoteDB.SetProductPrice((NewPrice.Value));
end;
