...
begin
 try
  ...
  ExportGrid.Cells[5,ExportGrid.RowCount-1]:='Quantité';
  ...
  ExportGrid.Cells[9,ExportGrid.RowCount-1]:='Catégorie console';
  ...
  while not RemoteDB.Stock.Eof do begin
   if RemoteDB.Products.Locate('products_model',RemoteDB.Stockproduct_model.AsString,[]) then begin
     ...
     ExportGrid.Cells[7,ExportGrid.RowCount-1]:='Normal Recommandé';
