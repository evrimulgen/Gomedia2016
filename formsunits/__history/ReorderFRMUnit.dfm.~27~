object ReorderForm: TReorderForm
  Left = 0
  Top = 0
  Caption = 'Commande de r'#233'assort'
  ClientHeight = 598
  ClientWidth = 778
  Color = clBtnFace
  ...
  object Grid: TcxGrid
    ...
    object Gridview: TcxGridDBTableView
      ...
      object GridviewIDART: TcxGridDBColumn
        DataBinding.FieldName = 'IDART'
        Options.Editing = False
      end
      ...
      object GridviewQSTOCK: TcxGridDBColumn
        Caption = 'STOCK'
        DataBinding.FieldName = 'QSTOCK'
      end
      ...
      object GridviewQCLD: TcxGridDBColumn
        DataBinding.FieldName = 'QCLD'
      end
    end
  ...
  object TableData: TdxMemData
    ...
    object TableDataIDART: TStringField
      FieldName = 'IDART'
    end
    object TableDataQCLD: TIntegerField
      FieldName = 'QCLD'
    end
    object TableDataQSTOCK: TIntegerField
      FieldName = 'QSTOCK'
    end
  end
